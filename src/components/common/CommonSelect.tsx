  ...
  return (
    ...
    >
      ...
      <Select.Positioner style={{ marginTop: '-52px' }}>
        <CustomSelect>
          <CustomSelectItem item={placeholder} style={{ color: colors.gray[6], pointerEvents: 'none', opacity: 0.5 }}>
            {placeholder}
          </CustomSelectItem>
...
const CustomSelectTrigger = styled(Select.Trigger, {
  ...
  border-radius: 8px;
  padding: 12px 16px;
  border: 1px solid ${({ isInvalid }) => isInvalid ? colors.gray[5] : colors.point};
`;
